...
{
    public class UpdateBannerAdCommand : UpdateAdCommandBase, IRequest
    {
        #region Properties
        ...
        public class Handler : UpdateAdCommandHandlerBase, IRequestHandler<UpdateBannerAdCommand>
        {
            #region Constructors
            ...
            public async Task<Unit> Handle(UpdateBannerAdCommand request, CancellationToken cancellationToken)
            {
