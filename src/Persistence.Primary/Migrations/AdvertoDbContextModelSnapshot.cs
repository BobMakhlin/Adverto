...
namespace Persistence.Primary.Migrations
{
    ...
    partial class AdvertoDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Primary.Entities.ViewedAd", b =>
                {
                    b.Property<Guid>("AdId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Primary.Entities.ViewedAd", b =>
                {
                    b.HasOne("Domain.Primary.Entities.Ad", "Ad")
                        .WithOne("ViewedAd")
                        .HasForeignKey("Domain.Primary.Entities.ViewedAd", "AdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
